...
-   ![](https://raw.githubusercontent.com/CorneliousJD/Docker-Templates/master/icons/stash.png){ align=left width="36" loading=lazy } Stash
...
## stash-s6 by feederbox826

<div class="grid cards" markdown>

-   ![](https://raw.githubusercontent.com/feederbox826/stash-s6/main/docs/icon/favicon.png){ align=left width="36" loading=lazy } stash-s6
...
1. Enable apps (if disabled) and search for `stash`.
1. Select preferred app. 
1. Modify paths to your preference.
1. Go to Docker tab and enable autostart for the app.