...
4. [Tasks]({{ site.baseurl }}/docs/In-app-Manual/Tasks)
  - [Identify]({{ site.baseurl }}/docs/In-app-Manual/Tasks/Identify)
  - [Auto Tagging]({{ site.baseurl }}/docs/In-app-Manual/Tasks/AutoTagging)
  - [Scene Filename Parser]({{ site.baseurl }}/docs/In-app-Manual/Tasks/SceneFilenameParser)
  - [JSON Specification]({{ site.baseurl }}/docs/In-app-Manual/Tasks/JSONSpec)
...
7. [Metadata Scraping]({{ site.baseurl }}/docs/In-app-Manual/Scraping)
  - [Scraper Development]({{ site.baseurl }}/docs/In-app-Manual/Metadata-Scraping/ScraperDevelopment)
8. [Plugins]({{ site.baseurl }}/docs/In-app-Manual/Plugins)
  - [External]({{ site.baseurl }}/docs/In-app-Manual/Plugins/ExternalPlugins)
  - [Embedded]({{ site.baseurl }}/docs/In-app-Manual/Plugins/EmbeddedPlugins)
