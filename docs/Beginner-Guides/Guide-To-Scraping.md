...
![How to generate PHashes on scan]({{ site.baseurl }}/docs/Beginner-Guides/assets/gen-phashes-on-scan.jpg)
...
![How to generate PHashes manually]({{ site.baseurl }}/docs/Beginner-Guides/assets/gen-phashes-manually.jpg)
...
![How to find the Scene Tagger]({{ site.baseurl }}/docs/Beginner-Guides/assets/find-scene-tagger.jpg)
...
![Running "Scrape All" and "Search"]({{ site.baseurl }}/docs/Beginner-Guides/assets/scrape-all-and-search.jpg)
...
![How to find a StashID]({{ site.baseurl }}/docs/Beginner-Guides/assets/find-stashid.jpg)
...
![How to create an API token on ThePornDB]({{ site.baseurl }}/docs/Beginner-Guides/assets/create-tpdb-token.jpg)
...
![Location of "scrapers" folder]({{ site.baseurl }}/docs/Beginner-Guides/assets/scrapers-folder-location.jpg)
...
![ThePornDB in the list of scene scrapers]({{ site.baseurl }}/docs/Beginner-Guides/assets/tpdb-scene-scraper-entry.jpg)
...
![Tagger source set to ThePornDB]({{ site.baseurl }}/docs/Beginner-Guides/assets/tagger-source-tpdb.png)
